...
class DraftModelConfig:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        # Slot zero is a teacher-forced anchor; slots 1..B-1 are speculative
        # successor tokens.  Keep this runtime contract explicit in exports.
        result["sample_from_anchor"] = False
        result["num_speculative_tokens"] = self.block_size - 1
        result["architectures"] = ["GLM53W4DraftModel"]
        return result
