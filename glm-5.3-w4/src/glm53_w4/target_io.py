...
from .contracts import validate_w4a8_target_config


SCHEMA = "formal-glm53-w4a8-target-io-v2"
...
def extract_w4a8_target_io(
    ...
    *,
    ...
    # ModelSlim keeps the authoritative per-tensor W4A8 ABI in this sidecar;
...
def load_frozen_target_io(
    ...
    *,
    ...
    if manifest.get("schema") != SCHEMA or manifest.get("target_quantization") != "W4A8":
        raise ValueError("unsupported or non-W4A8 target I/O artifact")
