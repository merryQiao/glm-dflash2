...
This orphan Git branch intentionally contains Stage C only. Stage A trajectory
generation, Stage B hidden extraction, deployment adapters, model weights, and
runtime images are not part of this archive.
