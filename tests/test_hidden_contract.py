...
class HiddenContractTests(unittest.TestCase):
    ...
    def test_stage_b_contract_is_position_aware_v3(self):
        from omni_sd.vllm_ascend_hidden import HIDDEN_CACHE_SCHEMA

        self.assertEqual(HIDDEN_CACHE_SCHEMA, "omni-thinker-hidden-cache-v3")
