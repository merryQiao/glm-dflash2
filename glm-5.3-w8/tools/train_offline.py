...
from glm53_w8.checkpointing import (  # noqa: E402
    TrainingProgress,
    load_checkpoint,
    save_checkpoint,
)
from glm53_w8.contracts import TARGET_CONTRACT  # noqa: E402
from glm53_w8.data import expand_training_window, select_training_window  # noqa: E402
from glm53_w8.dflash2 import DFlash2Model  # noqa: E402
from glm53_w8.distributed import (  # noqa: E402
    apply_fsdp2,
    configure_accumulation,
    initialize_distributed,
    shutdown_distributed,
)
from glm53_w8.dspark import DSparkModel  # noqa: E402
from glm53_w8.hidden_cache import HiddenCacheDataset  # noqa: E402
from glm53_w8.modeling import DraftModelConfig  # noqa: E402
from glm53_w8.target_io import load_frozen_target_io  # noqa: E402
from glm53_w8.trainer import OfflineDrafterTrainer, recipe_for  # noqa: E402
from glm53_w8.trainer import (  # noqa: E402
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Offline BF16 DSpark/DFlash2 training for formal GLM-5.3 W8A8."
    )
...
def _validate_cache_io(cache: HiddenCacheDataset, io: Any) -> None:
    ...
    if provenance.get("target_quantization") != "W8A8":
        raise ValueError("hidden cache was not extracted from W8A8 target")
...
def main() -> None:
    ...
    try:
        ...
        semantic = {
            "schema": "formal-glm53-w8-stage-c-v2",
            "method": args.method,
