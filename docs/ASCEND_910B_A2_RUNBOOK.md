...
and reports additive losses/denominators, DFlash2 pre-injection unary recall,
or DSpark TV/confidence components. Validation uses a fixed held-out window and
